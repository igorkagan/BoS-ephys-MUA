...
from compare_conditions.compare import build_timing_deep_dive_pool, rank_similar_different
...
class TimingDeepDivePoolTests(unittest.TestCase):
    def test_rank_similar_different_order(self) -> None:
        pool = [
        ...
        self.assertEqual([r["channel"] for r in similar], [1, 3])
        self.assertEqual([r["channel"] for r in different], [2, 3])
