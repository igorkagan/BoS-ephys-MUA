...
from bos_mua.dual_nhp import dual_nhp_run_label, resolve_go_seqs
...
from bos_mua.session_lists import SessionListConfig, is_confederate_list
...
def build_confederate_context(
    ...
    return PipelineContext(
        ...
        condition_key=label,
        layout="flat",
        trial_filters=trial_filters_for_go_seq(cfg.condition_key, go_seq),
